...
the Server program's file path for "record.txt" in the code. 

Lines 34 (input from file) and 203 (output to file) need to be changed, You can easily find these file reference with the comment
"//***CHANGE THIS FILE NAME TO SUITE YOUR FILE SYSTEM" above them
